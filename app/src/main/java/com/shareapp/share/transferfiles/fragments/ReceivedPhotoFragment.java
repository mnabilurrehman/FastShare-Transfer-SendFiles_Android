 ...
 */
public class ReceivedPhotoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_received_photo, container, false);
        ...
        arrayList = new ReceivedFiles().getImagesFiles();

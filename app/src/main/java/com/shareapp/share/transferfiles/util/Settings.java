...
public class Settings {
    ...
    private static final String TAG = "AppLog/Settings";
    ...
    public Object getDefault(Key key) {
        switch (key) {
            ...
            case TRANSFER_DIRECTORY:
                ...
                Log.d(TAG, "File Received Path: " + downloads.getAbsolutePath());
//                return downloads.getAbsolutePath();
                return new File(downloads, "ShareData").getAbsolutePath();

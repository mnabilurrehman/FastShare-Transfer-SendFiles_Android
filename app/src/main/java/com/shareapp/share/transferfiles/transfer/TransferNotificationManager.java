package com.shareapp.share.transferfiles.transfer;
...
class TransferNotificationManager {
    ...
    private static final String TAG = "AppLog/TrnsfrNotifiMgr";
     ...
     */
    TransferNotificationManager(Service service, Context context) {
        this.context = context;
        Log.v(TAG, "In TransferNotificationManager");
        mService = service;
        ...
        mIntent = PendingIntent.getActivity(
                mService,
                0,
                new Intent(mService, HistoryActivity.class),
                0
        );
...
//                    Toasty.success(context,"File received successfully").show();
                    updateMyActivity(context, "com.file.received.success");
                    ...
                    Log.d(TAG, "Transfer failed error: " + transferStatus.getError());
...
//        Intent intent = new Intent("update_main_activity_footer");
//

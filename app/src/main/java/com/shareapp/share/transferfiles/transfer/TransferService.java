...
public class TransferService extends Service {
    ...
    private static final String TAG = "AppLog/TransferService";
    ...
    public void onCreate() {
        ...
        Log.v(TAG, "In TransferService");

        mTransferNotificationManager = new TransferNotificationManager(this, context1);
        try {

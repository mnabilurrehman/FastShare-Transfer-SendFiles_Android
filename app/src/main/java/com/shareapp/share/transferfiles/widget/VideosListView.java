...
import com.shareapp.share.transferfiles.adapters.VideoListAdapter;
...
//		VideoAndAdItemListAdapter videoAndAdItemListAdapter = new VideoAndAdItemListAdapter(getContext());

//		setAdapter(videoAndAdItemListAdapter);

        VideoListAdapter videoListAdapter = new VideoListAdapter(getContext(), videos);
//		AdvertisingAdapter advertisingAdapter= new AdvertisingAdapter((MainActivity) context,videoListAdapter);
